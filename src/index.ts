...
program
  .command('use')
  .description('Register a local or remote git repository as the prompt source')
  .argument('[source]', 'Local path or git URL (default: current directory)')
